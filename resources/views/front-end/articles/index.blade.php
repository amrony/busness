                            ...
                            <div class="text_secL">
                                <div class="text_l  1" >
                                    <a href="singelpage2.html">
                                        <img src="{{ asset('back-end/images') }}/textim1.jpg" alt="Pineapple"
    ...
    <div class="container">
        <div class="row row-30">
            <div class="col-lg-3 wow fadeInLeft">
                <!--Brand--><a class="brand" href="index-2.html"><img class="brand-logo-dark" src="{{ asset('back-end/images') }}/logo-default-162x34.png" alt="img" /><img class="brand-logo-light" src="{{ asset('back-end/images') }}/logo-default-162x34.png" alt="img" /></a>
                <p class="footer-classic-description offset-top-0 offset-right-25">Cemeriss provides a full range of
                    business consulting & advisory services to small, medium, and international companies worldwide.
                    We use innovations and experience to drive your success.</p>
            </div>
