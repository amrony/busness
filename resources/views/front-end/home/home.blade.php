...
{{--    <section class="section main-section parallax-scene-js"--}}
{{--             style="background:url{{ asset('front-end/images/imgpsh_fullsize_anim.jpg') }} no-repeat center center; background-size:cover; height: 100vh">--}}
{{--             style="background:url{{ asset('front-end/images/imgpsh_fullsize_anim.jpg') }} no-repeat center center; background-size:cover;">--}}
{{--        <div class="container">--}}
{{--            <div class="row justify-content-center">--}}
{{--                <div class="col-xl-8 col-12">--}}
{{--                    <div class="main-decorated-box text-center text-xl-left">--}}
