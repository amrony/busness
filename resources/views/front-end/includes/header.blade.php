                    ...
                    <div class="rd-navbar-panel">
                        ...
                        <div class="rd-navbar-brand">
                            <a class="brand" href="index-2.html">
                                <img class="brand-logo-dark" src="assets/images/logo-default-162x34.png" alt="img"/>
                                <img class="brand-logo-light" src="assets/images/logo-inverse-162x34.png" alt="img"/>
                            </a>
                        </div>
                    </div>
